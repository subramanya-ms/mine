 ...
 *
 */
public class T2698Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2698Page(WebDriver browser) {
	...
	@FindBy(xpath = "//div[@class='slds-card__body']//tbody/tr[1]/th//a")
	 ...
	 * Functionality : validate T2698 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized T2698Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2698Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		
		String testcasemethod = new Object() {}.getClass().getEnclosingMethod().getName();
		
		try {
			
			String s_report = reusableComponents.getPropValues("selectreport_2698");
			String ledger = reusableComponents.getPropValues("ledg_2698");
			String s_period = reusableComponents.getPropValues("stperiod_2698");
			String e_period = reusableComponents.getPropValues("endperiod_2698");
