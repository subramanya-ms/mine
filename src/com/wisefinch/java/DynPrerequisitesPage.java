 ...
 *
 */
public class DynPrerequisitesPage extends DriverScript {
	 ...
	 * @param report
	 */
	protected DynPrerequisitesPage(WebDriver browser) {
		this.browser = browser;
		PageFactory.initElements(browser, this);

	}

	public DynPrerequisitesPage() {
...
//@FindBy(xpath = "//button[contains(text(),'New')]")
	...
	// primary array to contain all xpaths
	
	ArrayList<String> xpaths_pre = new ArrayList<String>();
	 ...
	 * 
	 ***/
	public synchronized DynPrerequisitesPage validateTestA(int threadID, List<String> tempList, String pathLoc)
	 ...
	 * 
	 ***/
	public synchronized DynPrerequisitesPage validateTestB(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
				...
				if (ReusableComponents.isElementPresent(New)) {
					...
					if (ReusableComponents.isElementPresent(Account_Name)) {
						...
						if (ReusableComponents.isElementPresent(Account_type)) {
							...
							WebElement accounttype = browser.findElement(By.xpath("//span[@title='"+account_type+"']"));
	 ...
	 * 
	 ***/
	public synchronized DynPrerequisitesPage validateTestC(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
	 ...
	 * 
	 ***/
	public synchronized DynPrerequisitesPage validateTestD(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
		testcasemethod = "Billing Line item";
		try {
	 ...
	 * 
	 ***/
	public synchronized DynPrerequisitesPage validateTestExcelRead(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		String testcasemethod = new Object() {
	 ...
	 * 
	 ***/
	public synchronized DynPrerequisitesPage validateinput_xpaths(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		String testcasemethod = new Object() {}.getClass().getEnclosingMethod().getName();
		
		
		try {

			String filename = reusableComponents.getPropValues("prerequisitefile");
			String sheetname = reusableComponents.getPropValues("ALL");
			...
			System.out.println("Row count is " +rowCount+ " Column count is " +columnCount);
			  ...
			  while(itr.hasNext()) { 
				  ...
				  if(row.getRowNum()==0){
				       continue; //just skip the rows if row number is 0 or 1
						  ...
						  xpaths_pre.add(formatter.formatCellValue(cell)); //throw new
			  ...
			  for(int i=0; i< xpaths_pre.size();i++) {
				  
				  System.out.println("xpaths are "+xpaths_pre.get(i));
			  }
	 ...
	 * 
	 ***/
	public synchronized DynPrerequisitesPage validateTestExcelWrite(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		String testcasemethod = new Object() {
