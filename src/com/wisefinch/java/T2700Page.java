 ...
 *
 */
public class T2700Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2700Page(WebDriver browser) {
	...
	@FindBy(xpath = "//label[contains(.,'Include Sub Type 2')]/span[@class='slds-checkbox_faux']")
	WebElement Include_Sub_t2;
	 ...
	 * Functionality : validate T2700 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized T2700Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2700Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		
		String testcasemethod = new Object() {}.getClass().getEnclosingMethod().getName();
		
		try {
			
			String s_report = reusableComponents.getPropValues("selectreport_2700");
			String ledger = reusableComponents.getPropValues("ledg_2700");
			String s_period = reusableComponents.getPropValues("stperiod_2700");
			String e_period = reusableComponents.getPropValues("endperiod_2700");
					...
					if (ReusableComponents.isElementNotPresent(Ledger)) {
						...
						if (ReusableComponents.isElementPresent(Starting_period)) {
							...
							if (ReusableComponents.isElementPresent(End_period)) {
								...
								if (Include_Sub_t2.isSelected() == false) {
							
									ReusableComponents.wait(4200);
									Include_Sub_t2.click();
									ReusableComponents.wait(4200);
									System.out.println("Include sub type 2 checkbox is unchecked");
									
								} else {
								
									System.out.println("Include sub type 2 is selected");
								}
	 ...
	 * 
	 ***/
	public synchronized T2700Page validateTestC(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		...
		try {
			...
			if (ReusableComponents.isElementPresent(Gen_report)) {
				...
				browser.findElement(By.cssSelector("body")).sendKeys(Keys.PAGE_DOWN);
				ReusableComponents.wait(4200);
				ReusableComponents.reportSpecific(threadID, tempList, testcasemethod, "screen grab of generated report", browser, pathLoc+"/"+testcasemethod, true);				
				ReusableComponents.wait(4200);
				browser.close();
				ReusableComponents.wait(4200);
