 ...
 *
 */
public class T2695Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2695Page(WebDriver browser) {
	 ...
	 * Functionality : validate T2696 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized T2696Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2696Page previousperiodclose(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2696Page previousyearclose(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2696Page currentperiodopen(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2696Page Nextyearopen(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2696Page RunreportTB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
