 ...
 *
 */
public class T2615Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2615Page(WebDriver browser) {
	 ...
	 * 
	 ***/
	public synchronized T2615Page Login(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException, throwNewException {
	 ...
	 * 
	 ***/
	public synchronized T2615Page PnLreport(int threadID, List<String> tempList, String pathLoc, String Startingperiod, String Endperiod) throws IOException, AWTException, throwNewException {
	...
	/***
	 * Test case Method Name : Testcase2615
	 * Functionality : validate T2615 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 ...
	 * 
	 ***/
	public synchronized T2615Page Testcase2615(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException, throwNewException {
		
		String testcasemethod = new Object() {}.getClass().getEnclosingMethod().getName();
		
		try {
			String Startingperiod = reusableComponents.getPropValues("period12615");
			String Endingperiod = reusableComponents.getPropValues("period22615");
