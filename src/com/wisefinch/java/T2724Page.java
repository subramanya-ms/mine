 ...
 *
 */
public class T2724Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2724Page(WebDriver browser) {
	...
	//@FindBy(xpath = "//tr[1]/th//span[@id='window']")
	 ...
	 * 
	 ***/
	public synchronized T2724Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2724Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	...
	return new T2724Page(browser);
		 ...
		 * 
		 ***/
		public synchronized T2724Page validateTestC(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		 ...
		 * 
		 ***/
		public synchronized T2724Page validateTestD(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		 ...
		 * 
		 ***/
		public synchronized T2724Page validateTestCashFlowError(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
				...
				if (ReusableComponents.isElementPresent(T_select)) {
					...
					if (ReusableComponents.isElementPresent(CF_edit)) {
						...
						if (ReusableComponents.isElementPresent(T_CF_removesel)) {
							...
							WebElement Cashflow_new = browser.findElement(By.xpath("//span[@title='1000-Cash']"));
							ReusableComponents.wait(5200);
							Cashflow_new.click();
		 ...
		 * 
		 ***/
		public synchronized T2724Page callingmethod(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
