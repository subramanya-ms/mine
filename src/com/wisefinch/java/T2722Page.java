 ...
 *
 */
public class T2722Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2722Page(WebDriver browser) {
	 ...
	 * 
	 ***/
	public synchronized T2722Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2722Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	...
	return new T2722Page(browser);
		 ...
		 * 
		 ***/
		public synchronized T2722Page validateTestC(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		 ...
		 * 
		 ***/
		public synchronized T2722Page validateTestD(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		 ...
		 * 
		 ***/
		public synchronized T2722Page validateTestCashFlow(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		 ...
		 * 
		 ***/
		public synchronized T2722Page callingmethod(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
