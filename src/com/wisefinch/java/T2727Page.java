 ...
 *
 */
public class T2727Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2727Page(WebDriver browser) {
	...
	@FindBy(xpath = "(.//*[@class='slds-truncate']//*[@class='slds-grid']//a/span[contains(text(),'TRN-')])[1]")
	WebElement T_select;
	
	@FindBy(xpath = "//button[@title='Edit Cash Flow Category']")
	WebElement CF_edit;
	
	@FindBy(xpath = "(//button[@title='Clear Selection'])[4]")
	WebElement T_CF_removesel;
	
	@FindBy(xpath = "//input[@placeholder='Search GL Accounts...']")
	WebElement T_CF_selectnew;
	 ...
	 * 
	 ***/
	public synchronized T2727Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2727Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	...
	return new T2727Page(browser);
		 ...
		 * 
		 ***/
		public synchronized T2727Page validateTestC(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		 ...
		 * 
		 ***/
		public synchronized T2727Page validateTestD(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		 ...
		 * 
		 ***/
		public synchronized T2727Page validateTestE(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		 ...
		 * Functionality : validate T2727 Page
		 * Created By : Lakshman
		 * 
		 * @throws IOException
		 * @throws AWTException
		 * 
		 ***/
		public synchronized T2727Page validateTestCashFlowError(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
			...
			try {
				...
				if (ReusableComponents.isElementPresent(T_select)) {
				
					ReusableComponents.wait(3200);
					T_select.click();
					ReusableComponents.reportPass(threadID, tempList, testcasemethod, "Transactions tabledata is present", browser, pathLoc + "/" + testcasemethod, false);
					...
					browser.findElement(By.cssSelector("body")).sendKeys(Keys.UP);
					browser.findElement(By.cssSelector("body")).sendKeys(Keys.UP);
					ReusableComponents.wait(5200);
					...
					if (ReusableComponents.isElementPresent(CF_edit)) {
						...
						if (ReusableComponents.isElementPresent(T_CF_removesel)) {
							...
							T_CF_removesel.click();
							ReusableComponents.wait(5500);
							
							if (ReusableComponents.isElementPresent(T_CF_selectnew)) {
								
								ReusableComponents.wait(3200);
								ReusableComponents.reportPass(threadID, tempList, testcasemethod, "Cash flow catogory selection field is present", browser, pathLoc + "/" + testcasemethod, false);
								T_CF_selectnew.click();
								ReusableComponents.wait(5500);
							
							WebElement Cashflow_new = browser.findElement(By.xpath("//span[@title='1001-Cash196']"));
							ReusableComponents.wait(5200);
							Cashflow_new.click();
					...
					ReusableComponents.reportFail(threadID, tempList, testcasemethod, "Transactions tabledata is NOT present", browser, pathLoc + "/" + testcasemethod, true);
				}
		 ...
		 * 
		 ***/
		public synchronized T2727Page callingmethod(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
