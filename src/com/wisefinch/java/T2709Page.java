 ...
 *
 */
public class T2709Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2709Page(WebDriver browser) {
	 ...
	 * Functionality : validate T2709 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized T2709Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2709Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
