 ...
 *
 */
public class T2708Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2708Page(WebDriver browser) {
	...
	@FindBy(xpath = "//*[@class='slds-truncate']//*[contains(text(),'Financial Statement Results')]")
	WebElement click_FSR;
	
	@FindBy(xpath = "//div[@title='Mass Delete']")
	WebElement Mass_delete;
	
	@FindBy(xpath = "//div[@class='pbHeader']//td[2]/input[1]")
	WebElement Mass_delete_final;
	 ...
	 * Functionality : validate T2708 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized T2708Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2708Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
						...
						if (ReusableComponents.isElementPresent(Starting_period)) {
							...
							if (ReusableComponents.isElementPresent(End_period)) {
								...
								if (ReusableComponents.isElementPresent(Run_report)) {
									...
									ReusableComponents.wait(5200);
									Report_name = Gen_report.getText();
									System.out.println("text selected"+Report_name);
	 ...
	 * 
	 ***/
	public synchronized T2708Page validateTestC(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		...
		try {
			...
			if (ReusableComponents.isElementPresent(Home)) {

				ReusableComponents.reportPass( threadID , tempList , testcasemethod , "Home button is present", browser ,pathLoc+"\\"+testcasemethod , false);
				ReusableComponents.wait(5200);
				Home.click();
				ReusableComponents.wait(5200);
				Input.sendKeys("Financial Statement Results");
				ReusableComponents.wait(5200);
				click_FSR.click();
				ReusableComponents.wait(5200);
				browser.navigate().refresh();
				ReusableComponents.wait(5200);
				ReusableComponents.reportSpecific(threadID, tempList, testcasemethod, "screen grab of Finanace Statement Results page", browser, pathLoc+"\\"+testcasemethod, true);
				ReusableComponents.wait(5200);
				ReusableComponents.reportPass( threadID , tempList , testcasemethod , "Finanace Statement Results page is present", browser ,pathLoc+"\\"+testcasemethod , false);
				ReusableComponents.wait(5200);
				
				List<WebElement> T = browser.findElements(By.xpath("//tbody/tr"));
				int i = T.size();
				System.out.println("No of reports = "+i);
				ReusableComponents.wait(5200);
				
				int j=1; String Report_N = null;
				for(j=1;j<=i;j++) {
					
					int k=j+1;
					WebElement Reprts = browser.findElement(By.xpath("//tbody/tr["+j+"]/th/span/a"));
					ReusableComponents.wait(5200);
					
					Report_N = Reprts.getText();
					System.out.println("report name FSR page "+Report_N);
					ReusableComponents.wait(5200);
					
					if(Report_name.equalsIgnoreCase(Report_N)) {
					
			
						try {
							//tr[1]//div[@class='slds-truncate']//a)[1]
							WebElement Reprt_sel = browser.findElement(By.xpath("//tbody/tr["+j+"]/td[2]//span[1]//label[@class='slds-checkbox']//span[1]"));
							ReusableComponents.wait(5200);
							Reprt_sel.click();
							...
							WebElement Reprt_sel2 = browser.findElement(By.xpath("//tbody/tr["+k+"]/td[2]//span[1]//label[@class='slds-checkbox']//span[1]"));
							ReusableComponents.wait(5200);
				...
				ReusableComponents.reportSpecific(threadID, tempList, testcasemethod, "screen grab of selected reports", browser, pathLoc+"\\"+testcasemethod, true);
				
				if (ReusableComponents.isElementPresent(Mass_delete)) {

					ReusableComponents.reportPass( threadID , tempList , testcasemethod , "Mass delete button is present", browser ,pathLoc+"\\"+testcasemethod , false);
					ReusableComponents.wait(5200);
					Mass_delete.click();
					ReusableComponents.wait(5200);
					ReusableComponents.reportSpecific(threadID, tempList, testcasemethod, "screen grab of mass delete finalising page", browser, pathLoc+"\\"+testcasemethod, true);
					ReusableComponents.wait(5200);
					
					browser.switchTo().frame(0);
					
					if (ReusableComponents.isElementPresent(Mass_delete_final)) {

						ReusableComponents.reportPass( threadID , tempList , testcasemethod , "Delete button is present", browser ,pathLoc+"\\"+testcasemethod , false);
						ReusableComponents.wait(5200);
						Mass_delete_final.click();
						ReusableComponents.wait(15200);
						ReusableComponents.reportSpecific(threadID, tempList, testcasemethod, "screen grab of confirmation message after mass delete action", browser, pathLoc+"\\"+testcasemethod, true);
						ReusableComponents.wait(5200);
						
					} else {
						ReusableComponents.reportFail(threadID, tempList, testcasemethod, "Delete button NOT present", browser, pathLoc + "\\" + testcasemethod, true);
						}
					browser.switchTo().defaultContent();
					
				} else {
					ReusableComponents.reportFail(threadID, tempList, testcasemethod, "Mass delete button NOT present", browser, pathLoc + "\\" + testcasemethod, true);
					}
				
			} else {
				ReusableComponents.reportFail(threadID, tempList, testcasemethod, "Home button NOT present", browser, pathLoc + "\\" + testcasemethod, true);
				}
	 ...
	 * 
	 ***/
	public synchronized T2708Page validateTestAll(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
