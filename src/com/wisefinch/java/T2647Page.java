 ...
 *
 */
public class T2647Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2647Page(WebDriver browser) {
	...
	/***
	 * Test case Method Name : Login Functionality : validate T2647 Page Created By
	 * : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 ...
	 * 
	 ***/
	public synchronized T2647Page Login(int threadID, List<String> tempList, String pathLoc)
	 ...
	 * @throws Exception
	 */
	public static T2647Page selectAppFromSearchAppAndItem(int threadID, List<String> tempList, String pathLoc,
	 ...
	 * @throws Exception
	 */
	public static T2647Page createLedger(int threadID, List<String> tempList, String pathLoc) throws Exception {
	...
	/***
	 * Test case Method Name : PnLvsBudgetreport Functionality : validate T2647 Page Created
	 * By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 ...
	 * 
	 ***/
	public synchronized T2647Page PnLvsBudgetreport(int threadID, List<String> tempList, String pathLoc,
	...
	/***
	 * Test case Method Name : Testcase2647 Functionality : validate T2647 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 ...
	 * 
	 ***/
	public synchronized T2647Page Testcase2647(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException, throwNewException {
		...
		try {
			testCaseNumber = "Testcase2647";
			newLedgerName = "Ledger_" + testCaseNumber + "_" + ReusableComponents.getCurrentDateAndTime("yyyyMMdd_HHmmss");
			String Starting_period = reusableComponents.getPropValues("startperiod2647");
			String Ending_period = reusableComponents.getPropValues("endperiod2647");
			...
			ReusableComponents.reportFail(threadID, tempList, testcasemethod,
					"Error During execution of test case 2647" + e.toString(), browser, pathLoc + "\\" + testcasemethod,
					true);
		}
