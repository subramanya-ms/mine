 ...
 *
 */
public class T2699Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2699Page(WebDriver browser) {
	...
	@FindBy(xpath = "(//div[@class='slds-truncate']//a[contains(.,'FRR-')])[1]/parent::*")
	 ...
	 * Functionality : validate T2699 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized T2699Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2699Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		
		String testcasemethod = new Object() {}.getClass().getEnclosingMethod().getName();
		
		try {
			
			String s_report = reusableComponents.getPropValues("selectreport_2699");
			String ledger = reusableComponents.getPropValues("ledg_2699");
			String s_period = reusableComponents.getPropValues("stperiod_2699");
			String e_period = reusableComponents.getPropValues("endperiod_2699");
	 ...
	 * 
	 ***/
	public synchronized T2699Page validateTestC(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
...
//			    executor.executeScript("arguments[0].click();", Gen_report);
				Gen_report.click();
