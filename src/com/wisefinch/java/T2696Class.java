...
public class T2696Class extends DriverScript{
	...
	@Test
	@Parameters({"platform" , "browserName" , "remoteurl"}) 
	public synchronized void validate_T2696Page_Rev1(@Optional("opt platform") String platform ,@Optional("opt browser name") String browserName ,@Optional("opt remoteurl") String remoteurl) throws IOException, AWTException{
...
//		System.out.println("Test Case  with Thread Id:- "+ Thread.currentThread().getId());
		...
		page.navigateToT2696Page(threadID,tempResultList ,pathLoc)
		.validateTestA(threadID, tempResultList, pathLoc)
		.previousperiodclose(threadID, tempResultList, pathLoc)
		.currentperiodopen(threadID, tempResultList, pathLoc)
		.RunreportTB(threadID, tempResultList, pathLoc)
		...
		ReusableComponents.reportInfo(threadID,tempResultList,testMethod , "Test case : Validating the Testcase1 Page test case", browser ,pathLoc+"\\"+TESTCASENAME , false );
