 ...
 *
 */
public class T2613Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2613Page(WebDriver browser) {
	 ...
	 * 
	 ***/
	public synchronized T2613Page Login(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException, throwNewException {
	 ...
	 * 
	 ***/
	public synchronized T2613Page PnLreport(int threadID, List<String> tempList, String pathLoc, String Startingperiod, String Endperiod) throws IOException, AWTException, throwNewException {
		...
		try {
			...
			if (Include_Subtype1.isSelected() == true) {
				
				ReusableComponents.wait(4200);
				Include_Subtype1.click();
				ReusableComponents.wait(4200);	
				System.out.println("Include Sub Type 1 checkbox is unchecked");
									
			} else {
								
				System.out.println("Include Sub Type 1 is already selected");
				}
			
			if (Include_Subtype2.isSelected() == false) {
				
				ReusableComponents.wait(4200);
				Include_Subtype2.click();
				ReusableComponents.wait(4200);	
				System.out.println("Include Sub Type 2 checkbox is checked");
									
			} else {
								
				System.out.println("Include Sub Type 2 is checkbox already unchecked");
				}
	 ...
	 * 
	 ***/
	public synchronized T2613Page Testcase2613(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException, throwNewException {
		
		String testcasemethod = new Object() {}.getClass().getEnclosingMethod().getName();
		
		try {
			String Startingperiod = reusableComponents.getPropValues("period12613");
			String Endingperiod = reusableComponents.getPropValues("period22613");
