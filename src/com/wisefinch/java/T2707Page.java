 ...
 *
 */
public class T2707Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2707Page(WebDriver browser) {
	 ...
	 * Functionality : validate T2707 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized T2707Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2707Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		
		String testcasemethod = new Object() {}.getClass().getEnclosingMethod().getName();
		
		try {
			
			String s_report = reusableComponents.getPropValues("selectreport_2707");
			String ledger = reusableComponents.getPropValues("ledg_2707");
			String s_period = reusableComponents.getPropValues("stperiod_2707");
			String e_period = reusableComponents.getPropValues("endperiod_2707");
