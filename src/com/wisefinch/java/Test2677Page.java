 ...
 *
 */
public class Test2677Page extends DriverScript{
	 ...
	 * @param report
	 */
	protected Test2677Page(WebDriver browser) {
...
String ignore_supressrows = null, ignore_subtype1 = null;
	 ...
	 * 
	***/
	public synchronized  Test2677Page Salesforce_login(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
	 ...
	 * 
	***/
	public synchronized  Test2677Page Navigation_page(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	 ...
	 * 
	***/
	public synchronized  Test2677Page validateTestOpp(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
	 ...
	 * 
	***/
	public synchronized  Test2677Page validateTestB(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
		/*
		 * boolean test=false;
...
//		  
	 ...
	 * 
	***/
	public synchronized  Test2677Page validateTestC(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
...
if(ReusableComponents.isElementPresent(dyn_dropdown)) { //dropdown
				 ...
				 // ReusableComponents.reportSpecific(threadID, tempList, testcasemethod,  "before report generation", browser, pathLoc+"/"+testcasemethod, true);
				  ...
				  { 
					  ReusableComponents.reportFail( threadID , tempList , testcasemethod ," Start btn input is not able to enter", browser ,pathLoc+"/"+testcasemethod , true ); 
				  }
			 ...
			 // ReusableComponents.reportSpecific(threadID, tempList, testcasemethod,  "before report generation", browser, pathLoc+"/"+testcasemethod, true);
			  ...
			  { 
				  ReusableComponents.reportFail( threadID , tempList , testcasemethod ,"Start time input is not identified", browser ,pathLoc+"/"+testcasemethod , true ); 
			  }
...
//					   js.executeScript("window.scrollBy(document.body.scrollHeight,0)");
	 ...
	 * 
	***/
	public synchronized  Test2677Page ValidateAssignerCode(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
...
//					   js.executeScript("window.scrollBy(document.body.scrollHeight,0)");
	 ...
	 * 
	***/
	public synchronized  Test2677Page validateTestD(int threadID , List<String> tempList , String pathLoc ) throws IOException, AWTException {
		String testcasemethod = new Object(){}.getClass().getEnclosingMethod().getName();
	try{
