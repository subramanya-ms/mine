...
public class Test2677Class extends DriverScript{
	...
	@Test
	@Parameters({"platform" , "browserName" , "remoteurl"}) 
	public synchronized void validate_Aseedtest_PL_Rev1(@Optional("opt platform") String platform ,@Optional("opt browser name") String browserName ,@Optional("opt remoteurl") String remoteurl) throws IOException, AWTException{
		
		TESTCASENAME = new Object(){}.getClass().getEnclosingMethod().getName();
		
		TESTCASENAME = "Financial Reports PL";
		String strClassName = new Object(){}.getClass().getName();
		
		strClassName = "Reports";
