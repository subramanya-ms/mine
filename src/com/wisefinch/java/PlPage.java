...
//@FindBy(xpath = "//a[contains(text(),'2020-06')]")
	...
	/***
	 * Test case Method Name : validateTestA Functionality : validate login to
	 * Accounting seed salesforce - Login_Salesforce Created By : Subramanya MS
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized PlPage Salesforce_login(int threadID, List<String> tempList, String pathLoc)
		...
		try {
			...
			if (ReusableComponents.isElementPresent(login_user_field)) {
				ReusableComponents.reportPass(threadID, tempList, testcasemethod,
						"salesforce login field is identified, inserting username dynamically", browser,
						pathLoc + "/" + testcasemethod, false);
				ReusableComponents.wait(1200);
				login_user_field.sendKeys(username);
				// ReusableComponents.reportPass( threadID , tempList , testcasemethod ,
				// "salesforce login username entered successfully", browser
				// ,pathLoc+"/"+testcasemethod , false );
				ReusableComponents.reportSpecific(threadID, tempList, testcasemethod,
						"salesforce login username entered successfully", browser, pathLoc + "/" + testcasemethod,
						true);

				if (ReusableComponents.isElementPresent(login_pass_field)) {

					ReusableComponents.reportPass(threadID, tempList, testcasemethod,
							"salesforce password is identified, inserting password dynamically", browser,
							pathLoc + "/" + testcasemethod, false);
					login_pass_field.sendKeys(pass_login);
					ReusableComponents.wait(1200);
					ReusableComponents.reportPass(threadID, tempList, testcasemethod,
							"salesforce password is entered successfully", browser, pathLoc + "/" + testcasemethod,
							false);

					if (ReusableComponents.isElementPresent(login_btn)) {

						ReusableComponents.reportPass(threadID, tempList, testcasemethod, "Login Button is identified",
								browser, pathLoc + "/" + testcasemethod, false);
						ReusableComponents.wait(1200);
						login_btn.click();
						ReusableComponents.wait(15500);
						ReusableComponents.reportPass(threadID, tempList, testcasemethod,
								"salesforce login button is clicked", browser, pathLoc + "/" + testcasemethod, false);
						...
						if (ReusableComponents.isElementPresent(Reports)) {
							...
							ReusableComponents.reportPass(threadID, tempList, testcasemethod,
									"Login Button is identified", browser, pathLoc + "/" + testcasemethod, false);
							ReusableComponents.wait(1200);
							Reports.click();
							ReusableComponents.wait(15500);
							ReusableComponents.reportPass(threadID, tempList, testcasemethod,
									"salesforce login button is clicked", browser, pathLoc + "/" + testcasemethod,
									false);

						} else {
							ReusableComponents.reportFail(threadID, tempList, testcasemethod,
									"reports tag is NOT present", browser, pathLoc + "/" + testcasemethod, true);
						}

					} else {
						ReusableComponents.reportFail(threadID, tempList, testcasemethod,
								"salesforce login button is NOT present successfully", browser,
								pathLoc + "/" + testcasemethod, true);
					}

				} else {
					ReusableComponents.reportFail(threadID, tempList, testcasemethod,
							" salesforce password field is NOT present successfully", browser,
							pathLoc + "/" + testcasemethod, true);
				}

			} else {
				ReusableComponents.reportFail(threadID, tempList, testcasemethod,
						"salesforce login field is NOT present successfully", browser, pathLoc + "/" + testcasemethod,
						true);
			}
	 ...
	 * 
	 ***/
	public synchronized PlPage Navigation_page(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
	...
	/***
	 * Test case Method Name : validateTestOpp Functionality : validate opportunity
	 * creation Created By : Subramanya MS
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized PlPage validateTestOpp(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
		try {
			...
			for (i = 0; i < counter; i++) {
				...
				if (ReusableComponents.isElementPresent(New_opp_btn)) {
					...
					ReusableComponents.reportFail(threadID, tempList, testcasemethod,
							"New_opp_btn is NOT present successfully", browser, pathLoc + "/" + testcasemethod, true);
				}

				try {
					ReusableComponents.wait(1200);

					WebElement ele1 = browser
							.findElement(By.xpath("//a[contains(@class,'datePicker-openIcon display')]"));
				...
				if (ReusableComponents.isElementPresent(opportunity_enter)) {
					...
					if (ReusableComponents.isElementPresent(stage_enter)) {
						...
						if (ReusableComponents.isElementPresent(select_stage)) {
							...
							new WebDriverWait(browser, 20).until(ExpectedConditions.elementToBeClickable(select_stage))
									.click();
							// select_stage.click();
							ReusableComponents.wait(1200);
							...
							if (ReusableComponents.isElementPresent(save_btn)) {
								...
								ReusableComponents.reportFail(threadID, tempList, testcasemethod,
										"save btn is NOT present successfully", browser, pathLoc + "/" + testcasemethod,
										true);
							}

						} else {
							ReusableComponents.reportFail(threadID, tempList, testcasemethod,
									"select stage is NOT present successfully", browser, pathLoc + "/" + testcasemethod,
									true);
						}

					} else {
						ReusableComponents.reportFail(threadID, tempList, testcasemethod,
								"stage enter is NOT present successfully", browser, pathLoc + "/" + testcasemethod,
								true);
					}

				} else {
					ReusableComponents.reportFail(threadID, tempList, testcasemethod,
							"opportunity enter is NOT present successfully", browser, pathLoc + "/" + testcasemethod,
							true);
				}
	...
	/***
	 * Test case Method Name : validateTestb Functionality : validate login to
	 * Accounting seed salesforce financial reports page old Created By : Subramanya
	 * MS
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized PlPage validateTestB(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
		try {
			 ...
			 * "btn is NOT present successfully", browser ,pathLoc+"/"+testcasemethod , true
			 * ); }
			 * 
...
//		  
					try {
						if (ReusableComponents.isElementPresent(first_input)) {
							...
							ReusableComponents.reportFail(threadID, tempList, testcasemethod,
									"first is NOT present successfully", browser, pathLoc + "/" + testcasemethod, true);
						}
					} catch (Exception e) {
						// TODO Auto-generated catch block
					...
					try {
						if (ReusableComponents.isElementPresent(second_input)) {
							...
							ReusableComponents.reportFail(threadID, tempList, testcasemethod,
									"second is NOT present successfully", browser, pathLoc + "/" + testcasemethod,
									true);
						}
					} catch (Exception e) {
						// TODO Auto-generated catch block
					...
					try {
						if (ReusableComponents.isElementPresent(btn_run_click)) {
							...
							// ReusableComponents.reportPass(threadID, tempList, testcasemethod, "test",
							// browser, pathLoc+"/"+testcasemethod, false);
							ReusableComponents.reportSpecific(threadID, tempList, testcasemethod,
									"before report generation", browser, pathLoc + "/" + testcasemethod, true);
						} else {
							ReusableComponents.reportFail(threadID, tempList, testcasemethod,
									"btn is NOT present successfully", browser, pathLoc + "/" + testcasemethod, true);
						}
						...
						// ReusableComponents.reportPass(threadID, tempList, testcasemethod, "test",
						// browser, pathLoc+"/"+testcasemethod, false);
						ReusableComponents.reportSpecific(threadID, tempList, testcasemethod, "processing", browser,
								pathLoc + "/" + testcasemethod, true);

						ReusableComponents.wait(13200);

						ReusableComponents.reportSpecific(threadID, tempList, testcasemethod, "report generated",
	...
	/***
	 * Test case Method Name : validateTestC Functionality : validate login to
	 * Accounting seed salesforce financial reports page Lightning Created By :
	 * Subramanya MS
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized PlPage validateTestC(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
...
//		enddate = reusableComponents.getPropValues("endvalue", "plconfig");
			...
			try {
				if (ReusableComponents.isElementPresent(new_start_time_btn)) {
					...
					ReusableComponents.reportPass(threadID, tempList, testcasemethod,
							"Start time btn is present and clearing selected start range", browser,
							pathLoc + "/" + testcasemethod, false);
					...
					if (ReusableComponents.isElementPresent(new_start_time_input)) {
						...
						ReusableComponents.reportPass(threadID, tempList, testcasemethod,
								"Start time start range is clicked", browser, pathLoc + "/" + testcasemethod, false);
						...
						ReusableComponents.reportPass(threadID, tempList, testcasemethod, "Start time btn is entered",
								browser, pathLoc + "/" + testcasemethod, false);

						ReusableComponents.wait(3200);

						WebElement dyn_dropdown = browser.findElement(By.xpath(
								"//div[@role='listbox']//ul[@role='presentation']//li[@role='presentation']//span[@data-recordname='"
										+ startdate + "']/span[2]/span[1]"));
						...
						if (ReusableComponents.isElementPresent(dyn_dropdown)) { // dropdown
							...
							dyn_dropdown.click();
							ReusableComponents.reportPass(threadID, tempList, testcasemethod,
									"start range value selected", browser, pathLoc + "/" + testcasemethod, false);
							...
							try {
								if (ReusableComponents.isElementPresent(new_end_time_btn)) {
									...
									ReusableComponents.reportPass(threadID, tempList, testcasemethod,
											"End time btn is present and clearing selected end range", browser,
											pathLoc + "/" + testcasemethod, false);
									...
									if (ReusableComponents.isElementPresent(new_end_time_input)) {
										...
										ReusableComponents.reportPass(threadID, tempList, testcasemethod,
												"End time entered", browser, pathLoc + "/" + testcasemethod, false);

										System.out.println("aft date");

										ReusableComponents.wait(3200);

										WebElement dyn_dropdown1 = browser.findElement(By.xpath(
												"//div[@role='listbox']//ul[@role='presentation']//li[@role='presentation']//span[@data-recordname='"
														+ enddate + "']/span[2]/span[1]"));
										...
										if (ReusableComponents.isElementPresent(dyn_dropdown1)) { // dropdown1
											...
											/*
											 * after clicking the end date, need to check if the check box is already
											 * selected or not if not then based on the test case we need to select it
											...
											try {
												if (ignore_supressrows.equalsIgnoreCase("true")) {
													...
													ReusableComponents.reportPass(threadID, tempList, testcasemethod,
															"supress zero amount rows not applicable", browser,
															pathLoc + "/" + testcasemethod, false);
												} else {
													...
													if (ReusableComponents
															.isElementPresent(check_suppressZeroAmountRows)) {
														...
														if (supressrows == true && isselected == true) {
															...
															ReusableComponents.reportPass(threadID, tempList,
																	testcasemethod,
																	"supress zero amount rows already matching",
																	browser, pathLoc + "/" + testcasemethod, false);
														}
														if (supressrows == false && isselected == true) {
															...
															ReusableComponents.reportPass(threadID, tempList,
																	testcasemethod,
																	"supress zero amount rows un checked now ", browser,
																	pathLoc + "/" + testcasemethod, false);
														}
														...
														if (supressrows == true && isselected == false) {
															...
															ReusableComponents.reportPass(threadID, tempList,
																	testcasemethod,
																	"supress zero amount rows checked now ", browser,
																	pathLoc + "/" + testcasemethod, false);
														}
														...
														ReusableComponents.reportFail(threadID, tempList,
																testcasemethod, " supress rows is NOT detected",
																browser, pathLoc + "/" + testcasemethod, true);
													}
												...
												e.printStackTrace();
												ReusableComponents.reportFail(threadID, tempList, testcasemethod,
														" supress rows is NOT detected", browser,
														pathLoc + "/" + testcasemethod, true);
											}
											...
											try {
												...
												if (ReusableComponents.isElementPresent(new_click_btn_run)) {
													...
													ReusableComponents.reportSpecific(threadID, tempList,
															testcasemethod, testcasemethod + " report generation",
															browser, pathLoc + "/" + testcasemethod, true);
													...
													System.out.println("run btn not present");
													ReusableComponents.reportFail(threadID, tempList, testcasemethod,
															" report generation is NOT detected", browser,
															pathLoc + "/" + testcasemethod, true);
												}
												...
												ReusableComponents.wait(4200);
												ReusableComponents.reportSpecific(threadID, tempList, testcasemethod,
														testcasemethod + "report generation", browser,
														pathLoc + "/" + testcasemethod, true);
											} catch (Exception e) {
												// TODO Auto-generated catch block
												e.printStackTrace();
...
//												   js.executeScript("window.scrollBy(document.body.scrollHeight,0)");
												...
												// this test is to see the generated report and click it, validate and
												// return back
												// which is not feasible in environments used by all as the records will
												// be more
												...
												if (ReusableComponents.isElementPresent(reportname)) {
													...
													// ReusableComponents.reportSpecific(threadID, tempList,
													// testcasemethod, "report name is
													// "+reportname.getText().toUpperCase()+" is generated in this
													// iteration", browser, pathLoc+"/"+testcasemethod, true);
													ReusableComponents.wait(1200);
													ReusableComponents.reportSpecific(threadID, tempList,
															testcasemethod,
															testcasemethod + " report name is "
																	+ reportname.getText().toUpperCase()
																	+ " and link for report "
																	+ reportname.getAttribute("href")
																	+ " is generated in this iteration",
															browser, pathLoc + "/" + testcasemethod, true);
													...
													ReusableComponents.reportFail(threadID, tempList, testcasemethod,
															" report name is NOT detected", browser,
															pathLoc + "/" + testcasemethod, true);
												}
											} catch (Exception e) {
												outarray.add("Report name - NA");
											...
											ReusableComponents.reportFail(threadID, tempList, testcasemethod,
													"end time range is selection is not present", browser,
													pathLoc + "/" + testcasemethod, true);
										}
...
//									  
										...
										// ReusableComponents.reportPass(threadID, tempList, testcasemethod, "test",
										// browser, pathLoc+"/"+testcasemethod, false);
										// ReusableComponents.reportSpecific(threadID, tempList, testcasemethod, "before
										// report generation", browser, pathLoc+"/"+testcasemethod, true);
									} else {
										ReusableComponents.reportFail(threadID, tempList, testcasemethod,
												"end time range is not present", browser,
												pathLoc + "/" + testcasemethod, true);
									}
									...
									ReusableComponents.reportFail(threadID, tempList, testcasemethod,
											"end time range is not present", browser, pathLoc + "/" + testcasemethod,
											true);
								}
							} catch (Exception e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
								ReusableComponents.reportFail(threadID, tempList, testcasemethod,
										"end time button is not present", browser, pathLoc + "/" + testcasemethod,
										true);
							}
							...
							// System.out.println("dropdown not present");
							ReusableComponents.reportFail(threadID, tempList, testcasemethod,
									"dropdown value is not selected - start date", browser,
									pathLoc + "/" + testcasemethod, true);
						}
						...
						ReusableComponents.reportFail(threadID, tempList, testcasemethod, "Start button is NOT present",
								browser, pathLoc + "/" + testcasemethod, true);
					}
					...
					ReusableComponents.reportFail(threadID, tempList, testcasemethod,
							"Start button is NOT present successfully", browser, pathLoc + "/" + testcasemethod, true);
				}
			} catch (Exception e) {
			...
			String filedetails = workingDir + "/Reports/" + filename;

			outarray.add(filedetails);
	...
	/***
	 * Test case Method Name : validateTest2677 Functionality : validate login to
	 * Accounting seed salesforce financial reports page Lightning Created By :
	 * Subramanya MS
	 * 
	 * @throws IOException
	 ...
	 * 
	 ***/
	public synchronized PlPage validateTest2677(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
		testcasemethod = "PL flow";
...
//									  
	...
	/***
	 * Test case Method Name : validateTest2678 Functionality : validate login to
	 * Accounting seed salesforce financial reports page Lightning Created By :
	 * Subramanya MS
	 * 
	 * @throws IOException
	 ...
	 * 
	 ***/
	public synchronized PlPage validateTest2678(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
		testcasemethod = "PL flow";
...
//									  
	...
	/***
	 * Test case Method Name : validateAssignerCode Functionality : validate login
	 * to Accounting seed salesforce financial reports page Lightning Created By :
	 * Subramanya MS
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized PlPage ValidateAssignerCode(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
		try {
			...
			ReusableComponents.reportPass(threadID, tempList, testcasemethod, "Reading Excel input sheet, successful",
					browser, pathLoc + "/" + testcasemethod, false);
			...
			} else if (startdate_arr.get(2) == null || startdate_arr.get(2).equalsIgnoreCase(" ")
					|| startdate_arr.get(2).equalsIgnoreCase("")) {
				ignore_supressrows = "true";
			}
...
//		enddate = reusableComponents.getPropValues("endvalue", "plconfig");
			...
			if (ReusableComponents.isElementPresent(new_start_time_btn)) {
				...
				if (ReusableComponents.isElementPresent(new_start_time_input)) {
					...
					ReusableComponents.reportFail(threadID, tempList, testcasemethod, "btn is NOT present successfully",
							browser, pathLoc + "/" + testcasemethod, true);
				}
			...
			if (ReusableComponents.isElementPresent(new_end_time_btn)) {
				...
				if (ReusableComponents.isElementPresent(new_end_time_input)) {
					...
					ReusableComponents.reportPass(threadID, tempList, testcasemethod, "End time entered", browser,
							pathLoc + "/" + testcasemethod, false);
...
//				  
					...
					/*
					 * after clicking the end date, need to check if the check box is already
					 * selected or not if not then based on the test case we need to select it else
					 * need to unselect it
					 * 
					 * add a case for NA
					 */
					...
					if (ignore_supressrows.equalsIgnoreCase("true")) {
						...
						ReusableComponents.reportPass(threadID, tempList, testcasemethod,
								"supress zero amount rows not applicable", browser, pathLoc + "/" + testcasemethod,
								false);
					} else {
						...
						if (ReusableComponents.isElementPresent(check_suppressZeroAmountRows)) {
							...
							if (supressrows == true && isselected == true) {
								// message - already as per requirement
								ReusableComponents.reportPass(threadID, tempList, testcasemethod,
										"supress zero amount rows already matching", browser,
										pathLoc + "/" + testcasemethod, false);
							}
							if (supressrows == false && isselected == true) {
							...
							System.out.println("run btn not present");
							ReusableComponents.reportFail(threadID, tempList, testcasemethod,
									" supress rows is NOT detected", browser, pathLoc + "/" + testcasemethod, true);
						}
...
//				  dropdown1.selectByVisibleText("2020-06");
					...
					if (ReusableComponents.isElementPresent(new_click_btn_run)) {
						...
						new_click_btn_run.click();
						ReusableComponents.wait(2200);
						ReusableComponents.reportSpecific(threadID, tempList, testcasemethod, "report generation",
								browser, pathLoc + "/" + testcasemethod, true);
					...
					ReusableComponents.wait(4200);
					ReusableComponents.reportSpecific(threadID, tempList, testcasemethod, "report generation", browser,
							pathLoc + "/" + testcasemethod, true);
...
//					   js.executeScript("window.scrollBy(document.body.scrollHeight,0)");
					...
					// this test is to see the generated report and click it, validate and return
					// back
					...
					if (ReusableComponents.isElementPresent(reportname)) {
						...
						// ReusableComponents.reportSpecific(threadID, tempList, testcasemethod, "report
						// name is "+reportname.getText().toUpperCase()+" is generated in this
						// iteration", browser, pathLoc+"/"+testcasemethod, true);
						ReusableComponents.wait(1200);
						ReusableComponents.reportSpecific(threadID, tempList, testcasemethod,
								"report name is " + reportname.getText().toUpperCase() + " and link for report "
										+ reportname.getAttribute("href") + " is generated in this iteration",
								browser, pathLoc + "/" + testcasemethod, true);
	...
	/***
	 * Test case Method Name : validateTestD Functionality : validate navigation to
	 * Accounting seed salesforce financial reports page Lightning Created By :
	 * Subramanya MS
	 * 
	 * @throws IOException
	 ...
	 * 
	 ***/
	public synchronized PlPage validateTestD(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
		try {
			...
			if (ReusableComponents.isElementPresent(new_click_btn_run)) {
				...
				try {
					...
					ReusableComponents.wait(1200);
					ReusableComponents.reportSpecific(threadID, tempList, testcasemethod,
							"report name is " + reportname.getText().toUpperCase() + " is generated in this iteration",
							browser, pathLoc + "/" + testcasemethod, true);
					...
					try {
						...
						ReusableComponents.reportSpecific(threadID, tempList, testcasemethod, "report page", browser,
								pathLoc + "/" + testcasemethod, true);
	 ...
	 * 
	 ***/
	public synchronized PlPage ValidateExcelOutput(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
		try {
...
//			}
	...
	/***
	 * Test case Method Name : Validatexpathreader Functionality : validate
	 * navigation to Accounting seed salesforce financial reports page Lightning
	 * Created By : Subramanya MS
	 * 
	 * @throws IOException
	 ...
	 * 
	 ***/
	public synchronized PlPage Hashmaper(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException {
		String testcasemethod = new Object() {
		}.getClass().getEnclosingMethod().getName();
		try {
					...
					while (itr.hasNext()) {
						...
						if (row.getRowNum() == 0) {
							...
							while (celliterator.hasNext()) {
								...
								// startdate_arr.add(formatter.formatCellValue(cell)); //throw new
								xpather.put(formatter.formatCellValue(row.getCell(0)),
...
//				}
					...
					if (xpather.containsKey(s)) {
						System.out.println("printing the value " + xpather.get(s));
					}
					...
					// write the action along with key and split them using index of

					// write a for loop, where we create the xpath method calls via that
					// make sure to call by key value pair
					// we might need to rewrite the strategy of writing xpaths
					...
					outarray.add("Sheet name NA");
					ReusableComponents.reportFail(threadID, tempList, testcasemethod,
							" Object is not present" + e.getStackTrace(), browser, pathLoc + "/" + testcasemethod,
							false);
				}
