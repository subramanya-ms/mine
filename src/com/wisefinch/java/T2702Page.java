 ...
 *
 */
public class T2702Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2702Page(WebDriver browser) {
	 ...
	 * Functionality : validate T2702 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized T2702Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2702Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
