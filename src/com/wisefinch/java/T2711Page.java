 ...
 *
 */
public class T2711Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2711Page(WebDriver browser) {
	 ...
	 * Functionality : validate T2711 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized T2711Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2711Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
