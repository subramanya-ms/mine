...
public class DriverScript {
	...
	// ExtentReports(resultpath+dateFormat.format(c.getTime())+"webdriverunresult1.html"
	// );
	...
	public static HashMap<String, String> runTimeTestData = new HashMap<String, String>();
