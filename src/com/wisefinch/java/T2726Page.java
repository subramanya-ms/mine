 ...
 *
 */
public class T2726Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2726Page(WebDriver browser) {
	 ...
	 * 
	 ***/
	public synchronized T2726Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2726Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	...
	return new T2726Page(browser);
		 ...
		 * 
		 ***/
		public synchronized T2726Page validateTestC(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		 ...
		 * 
		 ***/
		public synchronized T2726Page validateTestD(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		 ...
		 * 
		 ***/
		public synchronized T2726Page validateTestE(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		 ...
		 * 
		 ***/
		public synchronized T2726Page validateTestCashFlowError(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		 ...
		 * 
		 ***/
		public synchronized T2726Page callingmethod(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
