 ...
 *
 */
public class T2697Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2697Page(WebDriver browser) {
	 ...
	 * Functionality : validate T2697 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 * 
	 ***/
	public synchronized T2697Page validateTestA(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
	 ...
	 * 
	 ***/
	public synchronized T2697Page validateTestB(int threadID, List<String> tempList, String pathLoc) throws IOException, AWTException {
		
		String testcasemethod = new Object() {}.getClass().getEnclosingMethod().getName();
		
		try {
			
			String s_report = reusableComponents.getPropValues("selectreport_2697");
			String ledger = reusableComponents.getPropValues("ledg_2697");
			String s_period = reusableComponents.getPropValues("stperiod_2697");
			String e_period = reusableComponents.getPropValues("endperiod_2697");
