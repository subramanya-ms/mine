 ...
 *
 */
public class T2646Page extends DriverScript {
	 ...
	 * @param report
	 */
	protected T2646Page(WebDriver browser) {
	...
	/***
	 * Test case Method Name : Login Functionality : validate T2646 Page Created By
	 * : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 ...
	 * 
	 ***/
	public synchronized T2646Page Login(int threadID, List<String> tempList, String pathLoc)
	 ...
	 * @throws Exception
	 */
	public static T2646Page selectAppFromSearchAppAndItem(int threadID, List<String> tempList, String pathLoc,
	 ...
	 * @throws Exception
	 */
	public static T2646Page createLedger(int threadID, List<String> tempList, String pathLoc) throws Exception {
	...
	/***
	 * Test case Method Name : PnLvsBudgetreport Functionality : validate T2646 Page Created
	 * By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 ...
	 * 
	 ***/
	public synchronized T2646Page PnLvsBudgetreport(int threadID, List<String> tempList, String pathLoc,
	...
	/***
	 * Test case Method Name : Testcase2646 Functionality : validate T2646 Page
	 * Created By : Lakshman
	 * 
	 * @throws IOException
	 * @throws AWTException
	 ...
	 * 
	 ***/
	public synchronized T2646Page Testcase2646(int threadID, List<String> tempList, String pathLoc)
			throws IOException, AWTException, throwNewException {
		...
		try {
			testCaseNumber = "Testcase2646";
			newLedgerName = "Ledger_" + testCaseNumber + "_" + ReusableComponents.getCurrentDateAndTime("yyyyMMdd_HHmmss");
			String Starting_period = reusableComponents.getPropValues("startperiod2646");
			String Ending_period = reusableComponents.getPropValues("endperiod2646");
			...
			ReusableComponents.reportFail(threadID, tempList, testcasemethod,
					"Error During execution of test case 2646" + e.toString(), browser, pathLoc + "\\" + testcasemethod,
					true);
		}
